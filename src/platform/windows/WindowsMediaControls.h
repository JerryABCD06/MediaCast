...
//
// 一、面板按钮不能直接命令播放器。面板上按了暂停，要走 DlnaRenderer，和手机上按的
//     暂停是同一条路。绕过去的话 DLNA 那层不知道状态变了，订阅过的控制点收不到通知，
//     手机上就会显示成另一副样子 —— 这个坑踩过三次。
//
// 二、只读门面，不认识播放器。这个类跟 MainWindow 一样，手上只有 DlnaRenderer。
//
